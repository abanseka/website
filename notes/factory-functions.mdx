...
description: Pump Out New Objects from a Function
---

## ![Image By California Dispensary](https://i.pinimg.com/564x/01/80/0a/01800aa691ce14492ec46beca85aa7c1.jpg)

<a href="https://i.pinimg.com/originals/01/80/0a/01800aa691ce14492ec46beca85aa7c1.jpg">
  Image By Califonia Dispensary
</a>

A **factory function** is a function that returns a new object. The key feature of a factory is that its only job is to _pump out those items_, just like an actual factory.

The simplest factory function returns a static object of keys and values. Ever needed to turn a small list of values into an object? Take that [tuple](https://kyleshevlin.com/what-is-a-tuple) and give it to a factory function, like so:
...
When I created my [data structures and algorithms course on egghead](https://kyleshevl.in/dsa), I used factory functions to create the data structures. Let's make a `createQueue` factory to show you how this strategy projects.
...
function createQueue() {
  ...
  // This could have been a private method, if
  // we didn't also want to expose it
...
[SOURCE](https://kyleshevlin.com/what-is-a-factory-function)
